...
fn parse_frontmatter(
    ...
    let set_member_anchors =
        restore_standard_set_sources(&nel_safe_yaml, &mut raw, true, &initial_set_anchors);
    ...
    restore_standard_set_sources(&nel_safe_yaml, &mut raw, false, &empty_value_anchors);
