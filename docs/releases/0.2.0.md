...
- Registry: Open VSX
- Published `0.2.0` disposition: **Released on 2026-07-28; GitHub Release, Open VSX, target packages, and
...
This is a historical release record; none of its pass results qualifies the current source candidate.
